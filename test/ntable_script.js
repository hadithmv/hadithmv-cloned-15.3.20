...
$(document).ready(function() {
  ...
  function writeTable(data) {
    ...
    $('#ntable_insert').html(
      '<table cellpadding="0" cellspacing="0" border="0" class="ui very basic striped table definition selectable table-condensed table-responsive" id="mySelection"></table>'
    );
